...
type TemplateRenderer interface {
	...
	RenderIssueCreatedEventNotificationForSubscribedChannels(pl webhookpayload.Payload) (string, error)
	RenderIssueUpdatedEventNotificationForSubscribedChannels(pl webhookpayload.Payload) (string, error)
